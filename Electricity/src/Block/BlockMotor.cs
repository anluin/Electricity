...
{
    public class BlockMotor : Vintagestory.API.Common.Block, IMechanicalPowerBlock
    {
        ...
        {
            if (world.BlockAccessor.GetBlockEntity(pos) is BlockEntityMotor entity && entity.Facing != Facing.None)
            ...
            ItemStack byItemStack)
        {
            ...
            if (base.DoPlaceBlock(world, byPlayer, blockSel, byItemStack)
                && world.BlockAccessor.GetBlockEntity(blockSel.Position) is BlockEntityMotor entity)
            {
        ...
        public override void OnNeighbourBlockChange(IWorldAccessor world, BlockPos pos, BlockPos neibpos)
        {
            ...
            if (world.BlockAccessor.GetBlockEntity(pos) is BlockEntityMotor entity
            ...
            Vintagestory.API.Common.Block[] chunkExtBlocks, int extIndex3d)
        {
            ...
            if (api is ICoreClientAPI clientApi)
                if (api.World.BlockAccessor.GetBlockEntity(pos) is BlockEntityMotor entity &&
