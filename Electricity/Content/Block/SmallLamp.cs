...
namespace Electricity.Content.Block {
    public class SmallLamp : Vintagestory.API.Common.Block {
        ...
        public override void OnUnloaded(ICoreAPI api) {
            base.OnUnloaded(api);
            SmallLamp.MeshDataCache.Clear();
            SmallLamp.SelectionBoxesCache.Clear();
            SmallLamp.CollisionBoxesCache.Clear();
        }
        ...
        public override Cuboidf[] GetCollisionBoxes(IBlockAccessor blockAccessor, BlockPos pos) {
            ...
            if (
                ...
                if (!SmallLamp.CollisionBoxesCache.TryGetValue(key, out var boxes)) {
                    ...
                    if (boxes != null) SmallLamp.CollisionBoxesCache.Add(key, boxes);
                }
        ...
        public override Cuboidf[] GetSelectionBoxes(IBlockAccessor blockAccessor, BlockPos pos) {
            ...
            if (
                ...
                if (!SmallLamp.SelectionBoxesCache.TryGetValue(key, out var boxes)) {
                    if ((key.Facing & Facing.NorthEast) != 0) {
                    ...
                    if (boxes != null) SmallLamp.SelectionBoxesCache.Add(key, boxes);
                }
        ...
        public override void OnJsonTesselation(ref MeshData sourceMesh, ref int[] lightRgbsByCorner, BlockPos pos, Vintagestory.API.Common.Block[] chunkExtBlocks, int extIndex3d) {
            if (
                ...
                if (!SmallLamp.MeshDataCache.TryGetValue(key, out var meshData)) {
                    ...
                    SmallLamp.MeshDataCache.Add(key, meshData);
                }
