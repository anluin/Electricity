...
namespace Electricity.Content.Block {
    public class Heater : Vintagestory.API.Common.Block {
        ...
        public override void OnUnloaded(ICoreAPI api) {
            base.OnUnloaded(api);
            Heater.MeshDataCache.Clear();
            Heater.SelectionBoxesCache.Clear();
            Heater.CollisionBoxesCache.Clear();
        }
        ...
        public override bool DoPlaceBlock(IWorldAccessor world, IPlayer byPlayer, BlockSelection blockSel, ItemStack byItemStack) {
            ...
            if (
                ...
                world.BlockAccessor.GetBlockEntity(blockSel.Position) is Entity.Heater entity
            ) {
        ...
        public override void OnNeighbourBlockChange(IWorldAccessor world, BlockPos pos, BlockPos neibpos) {
            ...
            if (world.BlockAccessor.GetBlockEntity(pos) is Entity.Heater entity) {
        ...
        public override Cuboidf[] GetCollisionBoxes(IBlockAccessor blockAccessor, BlockPos pos) {
            ...
            if (
                this.api.World.BlockAccessor.GetBlockEntity(pos) is Entity.Heater entity &&
                entity.Facing != Facing.None
            ) {
                var key = CacheDataKey.FromEntity(entity);

                if (!Heater.CollisionBoxesCache.TryGetValue(key, out var boxes)) {
                    ...
                    if (boxes != null) Heater.CollisionBoxesCache.Add(key, boxes);
                }
        ...
        public override Cuboidf[] GetSelectionBoxes(IBlockAccessor blockAccessor, BlockPos pos) {
            ...
            if (
                ...
                if (!Heater.SelectionBoxesCache.TryGetValue(key, out var boxes)) {
                    if ((key.Facing & Facing.NorthEast) != 0) {
                    ...
                    if (boxes != null) Heater.SelectionBoxesCache.Add(key, boxes);
                }
        ...
        public override void OnJsonTesselation(ref MeshData sourceMesh, ref int[] lightRgbsByCorner, BlockPos pos, Vintagestory.API.Common.Block[] chunkExtBlocks, int extIndex3d) {
            if (
                ...
                if (!Heater.MeshDataCache.TryGetValue(key, out var meshData)) {
                    ...
                    Heater.MeshDataCache.Add(key, meshData);
                }
        ...
        internal struct CacheDataKey {
            ...
            public static CacheDataKey FromEntity(Entity.Heater entity) {
